...
const Contacts = () => {
  return (
    ...
    >
      ...
      <div className="w-full md:w-1/2 lg:w-[40%] px-1 pt-16 mt-10 lg:mt-0  justify-center flex-wrap">
        <div
          className="bg-cover bg-reach p-10 rounded-lg shadow-lg bg-blend-difference"
        ...
        >
          <form className="flex flex-col gap-4 ">
            ...
            <textarea
              ...
              className="p-2 rounded-lg border border-gray-300 h-36 w-full pr-0"
            ></textarea>
            <button
              type="submit"
